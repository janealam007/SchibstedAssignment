...
import com.tori.schibsted.repo.IPhotoSearchRepository
import com.tori.schibsted.repo.PhotoSearchRepository
...
object AppModule {
    ...
    @Provides
    @Singleton
    fun providePhotoSearchRepo(dataManager: DataManager): IPhotoSearchRepository {
        return PhotoSearchRepository(dataManager)
    }
}